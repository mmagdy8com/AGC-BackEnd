...
const { sendOtpOnPhone } = require('../middlewares/sendOtpOnPhone.js');
...
exports.signUp = async (req, res) => {
  try {
    ...
    // Additional validation for phoneNumber can be added here
    ...
    // Send OTP via SMS
    const { success, message, data } = await sendOtpOnPhone(
      phoneNumber,
